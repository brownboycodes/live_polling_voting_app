...
class PollResult extends StatelessWidget {
  ...
  ///[_screenshotArea] will be used for capturing the screenshot
  final GlobalKey _screenshotArea = GlobalKey();
      ...
      children: [
            ...
            child: Column(
              ...
              children: [
                ListTile(
                  ...
                  subtitle: Text(
                      "Total votes: ${poll.totalVotes < 10000 ? poll.totalVotes : '10000+'}",
                        ...
                        if (poll.totalVotes != 0)
                          TweenAnimationBuilder<int>(
                            ...
                            builder: (context, value, _) =>
                              ...
                              backgroundColor: pollOptionStyle
        ...
        Row(
          ...
          children: [
            Text("Share:"),
            IconButton(
                onPressed: () => PollResultViewModel()
                    .takeScreenShot(_screenshotArea, poll.id),
